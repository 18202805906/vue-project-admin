<template>
  <div class="auth-content">
    <div class="height: 230px">
      <span>
        <span class="left-icon" @click="nextConfig" v-if="showLeftIcon"><a-icon type="left" /></span>
                  ...
                  <a-col :span="24">
                    <div class="bottom-config">
                      <a-row>
                        ...
                        <a-col :span="11"
                          ><span><a-icon style="color: green" type="check" />&nbsp;选择</span></a-col
                        >
                      </a-row>
                    </div>
                  </a-col>
        ...
        <span class="right-icon" v-if="showRightIcon" @click="upConfig"><a-icon type="right" /></span>
      </span>
    </div>
