<template>
  <div>
    <div class="x-sider">
      <a-menu class="menu-box" :theme="theme" mode="inline"  :inline-collapsed="collapse" :selected-keys="selectedKeys" v-model:openKeys="localOpeneds">
...
<script>
import { toRefs, watchEffect, reactive, ref  } from 'vue';
export default {
  props: {
    collapse: {
      type: Boolean,
